...
| transfer across environments | PASS | environment: chase_chain -> corridor_with_pit | regret +0.0000 (excess +0.0000), tau +0.70, argmax hit 39%; excess regret +0.0000 vs limit 0.2719 (25% of a 1.0874 effect) |
...
- Exact closed-form solves, no sampling. Wall clock 7.4s.
